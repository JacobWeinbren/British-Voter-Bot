...
def intro_poster_alt(respondents: str, cadence: str) -> str:
    return (
        ...
        "in their own survey answers. How to read a card: the dot on the map is where they live, marked at their "
        "constituency; the speech bubbles are their views - favourite and least favourite leader, the issues they "
        "care about, how they see their nation; two scales show where they sit on the BES 0 to 10 economic left-right and "
        ...
        f"for now, grey if undecided. Voters are drawn from the wave's {respondents} respondents in proportion to BES survey weights, so "
