...
def eu_statement(row, country: int) -> str | None:
    ...
    if remain and rejoin:
        return ("I voted Remain in 2016, and I'd vote to rejoin the EU tomorrow.", "I voted Remain in 2016, and if there were another referendum, I'd vote to rejoin the EU.", "I was a Remain voter in 2016, and I'd vote to rejoin the EU today.")
...
def wished_vote(row, country: int) -> tuple[str, ...] | None:
    ...
    if not _party_noun(int(code)):
        return None
    return ("I wish I'd voted differently in 2024.",
...
def eu_ref_bond(row, country: int) -> str | None:
    ...
    if value(row, "euID6W24") == 4:
        return (f"When I meet a fellow {side[:-1]}, I feel a connection.", f"I feel a bond with any fellow {side[:-1]} I meet.", f"When I come across another {side[:-1]}, I feel connected to them.")
    return None
...
ITEMS: list[Item] = [
    ...
    Item("al1", "young-people", ("al1W31",),
         agree5(("Young people today don't have nearly enough respect for traditional British values.", "Young people have far too little respect for traditional British values."),
    ...
    Item("privatisation", "privatisation", ("privatTooFarW31", "privatTooFarW26"),
         too_far5(("Private companies have far too big a role in running public services.", "Having private companies run public services has gone much too far.", "Far too many of our public services are being run by private companies."),
                  ...
                  ("The role of private companies in public services is about right.", "The involvement of private companies in running public services is about right.", "I'd say the number of public services run by private companies is about right."),
    ...
    Item("taxSpend", "tax-and-spend", ("taxSpendSelfW31", "taxSpendSelfW30", "taxSpendSelfW28", "taxSpendSelfW27"),
         scale11(("Taxes should be cut a lot, even if it means spending much less on health and social services.", "I'd cut taxes a lot, even if that means spending much less on health and social services.", "Taxes should come down a lot, and spending on health and social services should come down a lot too."),
                 ...
                 ("We should raise taxes a lot and spend much more on health and social services.", "I'd raise taxes a lot and spend much more on health and social services.", "Taxes should go up a lot so we can spend much more on health and social services."),
    ...
    Item("howToReduceDeficit", "deficit", ("howToReduceDeficitW27",),
         by_code({1: ("If the deficit has to come down, do it through taxes, not cuts.", "Cut the deficit purely through tax rises, with no spending cuts.", "If we're cutting the deficit, it should be done only by raising taxes."),
                  2: ("Cut the deficit mainly with tax rises, with some spending cuts.", "Reduce the deficit mostly by raising taxes, with a few spending cuts too.", "I'd bring the deficit down mainly through higher taxes, plus some cuts."),
    ...
    Item("satDemUK", "democracy", ("satDemUKW29", "satDemUKW27"),
         by_code({1: ("I'm very dissatisfied with how democracy works in the UK.", "The way democracy works in the UK leaves me very dissatisfied.", "I'm really unhappy with how democracy works in the UK.", "I'm really unhappy with the way democracy works in the UK."), 2: ("I'm a bit dissatisfied with how democracy works in the UK.", "I'm a little dissatisfied with the way democracy works in the UK.", "How democracy works in the UK leaves me a bit dissatisfied.", "I'm somewhat unhappy with the way democracy works in the UK."),
    ...
    Item("immigCultural", "immigration", ("immigCulturalW27", "immigCulturalW24"),
         by_code({1: ("Immigration badly undermines Britain's cultural life.", "Immigration does real damage to Britain's cultural life.", "Britain's cultural life is badly undermined by immigration."), 2: ("Immigration undermines British cultural life.", "Immigration is bad for British cultural life.", "British cultural life is undermined by immigration."),
    ...
    Item("freeSpeechIslamistTV", "free-speech", ("freeSpeechIslamistTVW30",),
         by_code({1: ("A preacher who spreads hatred of the West should never be given airtime on TV.", "Someone who preaches hatred of the West should definitely not be allowed on TV to put their case.", "There's no way a preacher who spreads hatred of the West should get airtime on TV."),
                  2: ("A preacher who spreads hatred of the West probably shouldn't be on TV.", "I'd probably not let a preacher who spreads hatred of the West on TV.", "Someone who preaches hatred of the West probably shouldn't be given airtime on TV."),
                  3: ("Even a preacher who spreads hatred of the West should probably be allowed on TV.", "I'd probably let even a preacher who spreads hatred of the West on TV to put their case.", "Someone who preaches hatred of the West should probably still be allowed on TV to put their case."),
                  4: ("Even a preacher who spreads hatred of the West should be allowed on TV - that's free speech.", "A preacher who spreads hatred of the West should definitely be allowed on TV to put their case.", "Free speech means even someone who preaches hatred of the West should be allowed on TV.")}), weight=0.6),
    ...
    Item("brexitEconImpact", "economy-blame", (), custom=impact_item(("brexitEconImpactW31", "brexitEconImpactW30"),
    ...
    Item("brexitEconImpactWales", "economy-blame", (), custom=impact_item(("brexitEconImpactWalesW31", "brexitEconImpactWalesW30"),
    ...
    Item("freeSpeechIslamistElection", "free-speech", ("freeSpeechIslamistElectionW30",),
         by_code({1: ("A preacher who spreads hatred of the West should never be allowed to stand for election.", "I'd never let a preacher who spreads hatred of the West stand as an election candidate.", "There's no way a preacher who spreads hatred of the West should be allowed to stand for election."), 2: ("A preacher who spreads hatred of the West probably shouldn't stand for election.", "I probably wouldn't let a preacher who spreads hatred of the West stand for election.", "On balance, a preacher who spreads hatred of the West shouldn't be allowed to stand for election."),
                  3: ("Even a preacher who spreads hatred of the West should probably be allowed to stand for election.", "I'd probably let even a preacher who spreads hatred of the West stand for election.", "On balance, even a preacher who spreads hatred of the West should be allowed to stand for election."), 4: ("Even a preacher who spreads hatred of the West should be free to stand for election.", "Even a preacher who spreads hatred of the West should definitely be allowed to stand for election.", "A preacher who spreads hatred of the West has every right to stand for election, as far as I'm concerned.")}), weight=0.4),
    Item("freeSpeechIslamistSpeech", "free-speech", ("freeSpeechIslamistSpeechW30",),
         by_code({1: ("A preacher who spreads hatred of the West should never be allowed to speak in public round here.", "I'd never let a preacher who spreads hatred of the West make a speech in my community.", "There's no way a preacher who spreads hatred of the West should be allowed to speak round here."), 2: ("A preacher who spreads hatred of the West probably shouldn't speak in public round here.", "I probably wouldn't let a preacher who spreads hatred of the West make a speech in my community.", "On balance, a preacher who spreads hatred of the West shouldn't be allowed to speak round here."),
                  3: ("Even a preacher who spreads hatred of the West should probably be allowed to speak round here.", "I'd probably let even a preacher who spreads hatred of the West make a speech in my community.", "On balance, even a preacher who spreads hatred of the West should be allowed to speak in public round here."), 4: ("Even a preacher who spreads hatred of the West should be allowed to speak round here.", "Even a preacher who spreads hatred of the West should definitely be allowed to make a speech round here.", "A preacher who spreads hatred of the West has every right to speak in my community, as far as I'm concerned.")}), weight=0.4),
    Item("freeSpeechIslamistTeach", "free-speech", ("freeSpeechIslamistTeachW30",),
         by_code({1: ("A preacher who spreads hatred of the West should never be allowed to teach in a school.", "I'd never let a preacher who spreads hatred of the West teach 15-year-olds in a school.", "There's no way a preacher who spreads hatred of the West should be allowed to teach in schools."), 2: ("A preacher who spreads hatred of the West probably shouldn't teach in a school.", "I probably wouldn't let a preacher who spreads hatred of the West teach 15-year-olds in a school.", "On balance, a preacher who spreads hatred of the West shouldn't be allowed to teach in schools."),
                  3: ("Even a preacher who spreads hatred of the West should probably be allowed to teach in a school.", "I'd probably let even a preacher who spreads hatred of the West teach 15-year-olds in a school.", "On balance, even a preacher who spreads hatred of the West should be allowed to teach in schools."), 4: ("Even a preacher who spreads hatred of the West should be allowed to teach in a school.", "Even a preacher who spreads hatred of the West should definitely be allowed to teach in schools.", "A preacher who spreads hatred of the West has every right to teach in a school, as far as I'm concerned.")}), weight=0.4),
